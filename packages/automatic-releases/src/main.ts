...
export const main = async (): Promise<void> => {
  try {
    ...
    //let changelog = args.body ? (args.body as string) : (await getChangelog(client, context.repo.owner, context.repo.repo, commitsSinceRelease) as string);
    ...
    const releaseUploadUrl = await generateNewGitHubRelease(client, {
      ...
      body: bodyText, // args.body ? args.body : changelog,
    });
